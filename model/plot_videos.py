...
def plot_video(joints,
    ...
    for (j, frame_joints) in enumerate(joints):
        ...
        frame_joints_2d = np.reshape(frame_joints, (50, 2))
        """
        temp_points=frame_joints_2d[8:29]
        frame_joints_2d[8:29]=frame_joints_2d[29:50]
        frame_joints_2d[29:50]=temp_points
        """
        ...
        if references is not None:
            ...
            ref_joints_2d = np.reshape(ref_joints, (50, 2))
